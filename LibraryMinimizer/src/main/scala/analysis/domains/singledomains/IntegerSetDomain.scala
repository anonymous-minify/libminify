...
trait IntegerSetDomain extends BaseAnalysisDomain
  ...
  override type CalledMethodDomain = IntegerSetInvocationAnalysisDomain
}


class IntegerSetInvocationAnalysisDomain(
                                          ...
                                          val callerDomain: IntegerSetDomain,
  ...
  override def calledMethodDomain(method: Method) = {
    new IntegerSetInvocationAnalysisDomain(
      project,
...
class LibraryMinimizerAnalysisIntegerSetDomain(
                                                val project: Project[URL],
                                                val fieldValueInformation: FieldValueInformation,
                                                val methodReturnValueInformation: MethodReturnValueInformation,
                                                val cache: CallGraphCache[MethodSignature, scala.collection.Set[Method]],
