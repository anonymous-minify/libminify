...
trait LongSetDomain extends BaseAnalysisDomain
  ...
  override type CalledMethodDomain = LongSetInvocationAnalysisDomain
}


class LongSetInvocationAnalysisDomain(val project: Project[URL],
                                      ...
                                      val callerDomain: LongSetDomain,
  ...
  override def calledMethodDomain(method: Method) = {
    new LongSetInvocationAnalysisDomain(
      project,
...
class LibraryMinimizerAnalysisLongSetDomain(val project: Project[URL],
                                            val fieldValueInformation: FieldValueInformation,
                                            val methodReturnValueInformation: MethodReturnValueInformation,
                                            val cache: CallGraphCache[MethodSignature, scala.collection.Set[Method]],
                                            override val maxCardinalityOfLongSets: Int,
